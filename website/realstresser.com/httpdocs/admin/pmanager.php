...
while ($show = $SQLSelect -> fetch(PDO::FETCH_ASSOC))
{
	...
	echo '<tr><td><a href="plan.php?id='.$id.'">'.htmlspecialchars($planName).'</a></td><td><center>'.$mbtShow.' Seconds</center></td><td><center>$'.htmlentities($price).'</center></td><td><center>'.htmlentities($length).' '.htmlentities($unit).'</center></td><td><center>'.htmlentities($concurrents).'</center></td><td><center>'.htmlentities($private).'</center></td><td><center>'.$premium.'</center></td><td><center>'.$api.'</center></td></tr>';
}
