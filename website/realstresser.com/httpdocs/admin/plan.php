...
$currentPremium = $planInfo['premium'];
  ...
  <script src="../assets/js/spinner.js"></script>
			...
			<div class="col-md-12 grid-margin stretch-card">
              <div class="card">                
                    ...
                    <option value="1" <?php echo selectedPrivate(1, $currentPremium); ?>>Yes</option>
                    <option value="0" <?php echo selectedPrivate(0, $currentPremium); ?>>No</option>
                                            </select>
                                        </div>
                                    </div>
									<div class="row-form">
                                        ...
                                        <div class="col-md-12">
                                            <select name="private" class="form-control">
                    <option value="1" <?php echo selectedPrivate(1, $currentAPI); ?>>Yes</option>
                    <option value="0" <?php echo selectedPrivate(0, $currentAPI); ?>>No</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="row-form">
