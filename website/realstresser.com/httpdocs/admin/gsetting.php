              ...
              <div class="card">
                              <div class="card text-white bg-primary">
                                <div class="card-header text-center">General Settings</div>
									...
									<div class="row-form">
                                        <div class="col-md-4"><strong>Notice Message:</strong></div>
                                        <div class="col-md-12"><input type="text" class="form-control tip" name="alert" title="Leave empty for notice off" value="<?php echo htmlspecialchars($alert); ?>"/></div>
                                    </div>
                                    <div class="row-form">
                                    ...
                                    <!--<div class="row-form">
                                        <div class="col-md-4"><strong>Free Premium Methods Mode:</strong></div>
                                        <div class="col-md-12"><input  type="checkbox" name="premiumMethodsFree"  <?php //if ($premiumMethodsFree == 1) { echo 'checked'; } ?>/></div>
                                    </div>-->
